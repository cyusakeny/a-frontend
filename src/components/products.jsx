const Products = ()=>{
    return(
        <div className="flex flex-row w-[100%]  h-[38px] space-x-[30px] md:space-x-[40px] border-b-[1px] mb-[2%]">
        <span className="w-[3%] ">1</span>
        <span className=" md:w-[8%] relative bottom-4 right-[-5px] md:right-3 ">
            <img 
src="https://images.unsplash.com/photo-1618354691551-44de113f0164?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1430&q=80"
             alt="" className=" w-[60px] md:w-[50px] h-[50px] md:h-[50px]"/>
        </span>
