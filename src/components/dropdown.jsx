...
return(
    <div className={` flex-col bg-white w-[70%]  justify-center  h-screen
    `}> 
    ...
    <div className=" h-12 flex items-center mb-[12%] justify-center w-auto ml-[25%]"  
    
    >
        <span className="font-mono text-base tracking-normal font-bold text-gray-700 
